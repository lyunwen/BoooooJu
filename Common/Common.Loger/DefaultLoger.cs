...
namespace Common.Loger
{
    public class DefaultLoger : ILoger
    {
        ...
        public Task LogAsync(string Tips, Exception exception, string fileName, LogLevel level)
        { 
            return Task.Run(() => Log(Tips, exception, fileName, level)); 
        }

        void ILoger.Log<T>(T t)
        {
            throw new NotImplementedException();
        }

        void ILoger.Log(string Tips, Exception exception, string fileName, LogLevel level)
        {
            throw new NotImplementedException();
        }

        Task ILoger.LogAsync(string Tips, Exception exception, string fileName, LogLevel level)
        {
            throw new NotImplementedException();
        }
    }
