    ...
    public class RouteConfig
    {
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapRoute(
                ...
                namespaces: new string[] { "BoooooJu.WeChat.Core.Controllers" }
            );
            routes.MapRoute(
                name: "Default2",
    ...
    public class AgentAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
                ...
                namespaces: new string[] { "BoooooJu.WeChat.Core.Areas.Agent.Controllers" }
             );
            context.MapRoute(
                 "Agent_default2",
    ...
    public class VendorAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
                 ...
                 new { action = "Index", id = UrlParameter.Optional },
                namespaces: new string[] { "BoooooJu.WeChat.Core.Areas.Vendor.Controllers" }
             );
            context.MapRoute(
                 "Vendor_default2",
    ...
    public class ManagerAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
                 ...
                 new { action = "Index", id = UrlParameter.Optional },
                namespaces: new string[] { "BoooooJu.WeChat.Core.Areas.Manager.Controllers" }
             );
            context.MapRoute(
                 "Manager_default2",
    ...
    public class SuperManagerAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
                 ...
                 new { action = "Index", id = UrlParameter.Optional },
                namespaces: new string[] { "BoooooJu.WeChat.Core.Areas.SuperManager.Controllers" }
             );
            context.MapRoute(
